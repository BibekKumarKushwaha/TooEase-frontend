...
//     if (!firstName.trim()) errors.firstName = 'First name is required!';
//     if (!lastName.trim()) errors.lastName = 'Last name is required!';
//     if (!email.trim() || !emailRegex.test(email)) errors.email = 'A valid email is required!';
//     if (!phone.trim() || phone.length < 10) errors.phone = 'A valid phone number is required!';
//     if (!password.trim()) {
//       errors.password = 'Password is required!';
//     } else if (!passwordRegex.test(password)) {
...
//         toast.error(res.data.message);
//       } else {
//         // Updated success message to instruct email verification
//         toast.success('Registration successful! Please check your email to verify your account before logging in.');

//         // Remove or comment out the navigation to the login page
//         // navigate('/login');
...
//     setPasswordStrength({ percentage: 0, label: '' });
//     setErrors({});
//   };
        ...
        <div className="register-form">
          {!isRegistered ? (
            ...
            <div className="confirmation-message">
              ...
              <p>
                Please check your email inbox for a verification link. Click on the link to verify your account and
                proceed to login.
              </p>
              {/* Optional: Remove or comment out the login button to enforce verification */}
              {/* <button onClick={handleLoginRedirect} className="go-to-login-btn">
                Go to Login
              </button> */}
            </div>
          )}
